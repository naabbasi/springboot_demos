    ...
    public CommandLineRunner loadData(PersonRepository personRepository) {
        return args -> {
            ...
            ExampleDataGenerator<Person> personRepositoryGenerator = new ExampleDataGenerator<>(Person.class,
                    LocalDateTime.of(2021, 7, 7, 0, 0, 0));
            personRepositoryGenerator.setData(Person::setId, DataType.ID);
            personRepositoryGenerator.setData(Person::setFirstName, DataType.WORD);
            personRepositoryGenerator.setData(Person::setLastName, DataType.WORD);
            personRepositoryGenerator.setData(Person::setDob, DataType.DATE_OF_BIRTH);
